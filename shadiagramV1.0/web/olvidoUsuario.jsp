    ...
    <body>
        <div class="contenedor-formularios">
            ...
            <div class="contenido-tab" name="div">
                <div id="h1"><h1 class="text-center">Recuperar Usuario</h1></div>
                <div id="alerta"></div>
                <c:if test="${mensaje!=null}">
                    <div  class="alert alert-danger"><a  id="alerta3" href="" class="close" data-dismiss="alert">&times;</a>${mensaje}</div>
                </c:if>

                <form name="addForm" action="login?accion=olvidoU" method="post">
                    ...
                    <input type="submit" onclick="return validarUser();" class="button button-block" value="Enviar">
                </form>
            </div>
        </div>
